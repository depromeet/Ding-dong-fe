...
export const CommunityDetail = ({
  ...
  return (
    <div>
      ...
      <div className="flex w-[calc(100vw-40px)] max-w-[calc(410px-40px)] translate-x-[20px] translate-y-[-48px] items-center gap-12pxr rounded-3xl border border-grey-100 bg-white p-18pxr">

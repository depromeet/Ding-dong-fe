...
import { ConfirmCreateIdCard } from './index';

const meta: Meta<typeof ConfirmCreateIdCard> = {
  title: 'components/ConfirmCreateIdCard',
  component: ConfirmCreateIdCard,
  args: {},
};

export default meta;

type Story = StoryObj<typeof ConfirmCreateIdCard>;
  ...
  render: () => {
    ...
    return (
      <div className="flex w-full flex-col items-center justify-center gap-20pxr">
        ...
        {isOpen && <ConfirmCreateIdCard confirm={confirm} />}
      </div>
    );
  },
};
